            ...
            verifiableCredential: [
                {
                    ...
                    description:
                        'THIS GS1 DIGITAL LICENSE CREDENTIAL IS FOR TESTING PURPOSES ONLY. A GS1 Company Prefix Licence is issued by a GS1 Member Organisation or GS1 Global Office and allocated to a user company or to itself for the purpose of generating tier 1 GS1 identification keys.',
                    ...
                    credentialSubject: {
                        ...
                        extendsCredential:
                            'https://did-vc.gs1.org/vc/licence/gs1_prefix/08',
                    ...
                    proof: {
                        ...
                        proofValue:
                            'z5psp5E44P3ASSk9y7nhg9x24ny5BKBmPYeEHRMdm3rcnyAM393YFeVY4fmy4xfqbT5khfAqMrGZUzAjHCYb4XigH',
                    },
                },
            ],
            id: 'http://did-vc.gs1us.org/vc/licence/08600057694',
            ...
            results: [
                {
                    ...
                    verificationMethod: {
                        ...
                        publicKeyMultibase:
                            'z6Mkig1nTEAxna86Pjb71SZdbX3jEdKRqG1krDdKDatiHVxt',
                    },
                    purposeResult: {
                        valid: true,
                    },
            ...
            verifiableCredential: [
                {
                    ...
                    proof: {
                        ...
                        proofPurpose: 'assertionMethod',
                        proofValue:
                            'fail_z5psp5E44P3ASSk9y7nhg9x24ny5BKBmPYeEHRMdm3rcnyAM393YFeVY4fmy4xfqbT5khfAqMrGZUzAjHCYb4XigH',
                    },
                },
            ],
            id: 'http://did-vc.gs1us.org/vc/licence/08600057694',
...
export async function testMappingCredential_passResult(): Promise<verificationResult> {
    const gs1CredentialCheckResult: gs1RulesResultContainer = {
        verified: false,
        result: [],
    }
    const resultVC = await createVerificationResult(
        vcResultPass_ToMap,
        gs1CredentialCheckResult
    )
...
export async function testMappingCredential_failResult(): Promise<testVerificationResult> {
    ...
    gs1CredentialCheckResult.result.push({
        credentialId: 'Test_CredentialId',
